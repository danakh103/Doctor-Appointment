...
import com.medi360.utils.AppUtils;
import com.medi360.utils.FetchAddressIntentService;

public class SelectAddressFromMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
...
//        getSupportActionBar().setCustomView(R.layout.toolbar);
        ...
        mLocationMarkerText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mLocationMarkerText.getText().equals(" SET YOUR LOCATION ")){
                    try{
                        System.out.println("setting addres");
                        System.out.println("before address");
                        System.out.println(mAddressOutput);
                        globalParams.setSelectedAddress(mAddressOutput);
                        System.out.println("after setting address");
                        System.out.println(globalParams.getSelectedAddress());
                        globalParams.setSelectedAddrLat(String.valueOf(mCenterLatLong.latitude));
                        globalParams.setSelectedAddrLong(String.valueOf(mCenterLatLong.longitude));


                        finish();
                        Intent back=new Intent(SelectAddressFromMapActivity.this,AppointmentAddressActivity.class);
                        startActivity(back);
                    }catch(Exception err){
                    ...
                    System.out.println("Please wait your location is loading");
                }
